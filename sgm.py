...
class Parameters:
    def __init__(self, max_disparity=64, P1=10, P2=70, csize=(7, 7), bsize=(3, 3)):
        """
...
def sgm():
    ...
    parser.add_argument('--left', default='ALL-2views/Baby1/view1.png', help='name (path) to the left image')
    parser.add_argument('--right', default='ALL-2views/Baby1/view5.png', help='name (path) to the right image')
    ...
    parameters = Parameters(max_disparity=disparity, P1=20, P2=70, csize=(7, 7), bsize=(3, 3))
    paths = Paths()
    ...
    # nameP = '5_70'
    cv2.imwrite('output/'+'left_'+output_name, left_disparity_map)
    cv2.imwrite('output/'+'right_'+output_name, right_disparity_map)
